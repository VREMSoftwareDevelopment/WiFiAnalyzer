...
public class SortByChannelTest {
    ...
    @Test
    public void testSortByChannelWithDifferentChannel() {
        // setup
        WiFiDetail wiFiDetail1 = new WiFiDetail("SSID1", "BSSID1", StringUtils.EMPTY,
            new WiFiSignal(2462, 2462, WiFiWidth.MHZ_20, -55, true),
            WiFiAdditional.EMPTY);
        WiFiDetail wiFiDetail2 = new WiFiDetail("SSID1", "BSSID1", StringUtils.EMPTY,
            new WiFiSignal(2432, 2462, WiFiWidth.MHZ_20, -55, true),
            WiFiAdditional.EMPTY);
        // execute
        int actual = fixture.compare(wiFiDetail1, wiFiDetail2);
        // validate
    ...
    @Test
    public void testSortByChannelWithDifferentSSID() {
        // setup
        WiFiDetail wiFiDetail1 = new WiFiDetail("ssid1", "BSSID1", StringUtils.EMPTY,
            new WiFiSignal(2462, 2462, WiFiWidth.MHZ_20, -55, true),
            WiFiAdditional.EMPTY);
    ...
    @Test
    public void testSortByChannelWithDifferentBSSID() {
        // setup
        WiFiDetail wiFiDetail1 = new WiFiDetail("SSID1", "bssid1", StringUtils.EMPTY,
            new WiFiSignal(2462, 2462, WiFiWidth.MHZ_20, -55, true),
            WiFiAdditional.EMPTY);
    ...
    @Test
    public void testSortByChannelWithDifferentStrength() {
        // setup
        WiFiDetail wiFiDetail1 = new WiFiDetail("SSID1", "BSSID1", StringUtils.EMPTY,
            new WiFiSignal(2462, 2462, WiFiWidth.MHZ_20, -55, true),
            WiFiAdditional.EMPTY);
