...
public class AccessPointDetailCompactTest {
    ...
    public void setUp() {
        ...
        view = MainContext.INSTANCE.getLayoutInflater().inflate(R.layout.access_point_view_compact, null);
        assertNotNull(view);
    ...
    public void testSetViewCompactWithTabGone() throws Exception {
        ...
        // execute
        fixture.setViewCompact(mainActivity.getResources(), view, wiFiDetail, false);
        // validate
    ...
    public void testSetViewCompactWithTabVisible() throws Exception {
        ...
        // execute
        fixture.setViewCompact(mainActivity.getResources(), view, wiFiDetail, true);
        // validate
