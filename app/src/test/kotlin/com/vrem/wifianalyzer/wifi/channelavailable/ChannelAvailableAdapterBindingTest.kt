...
class ChannelAvailableAdapterBindingTest {
    ...
    fun testChannelAvailableAdapterBinding() {
        ...
        whenever(view.findViewById<TextView>(R.id.channel_available_title2_g_hz)).thenReturn(channelAvailableTitleGhz2)
        whenever(view.findViewById<TextView>(R.id.channel_available2_g_hz)).thenReturn(channelAvailableGhz2)
