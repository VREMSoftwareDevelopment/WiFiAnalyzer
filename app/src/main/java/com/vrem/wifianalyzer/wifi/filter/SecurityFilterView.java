...
class SecurityFilterView extends EnumFilterView<Security, SecurityFilter> {
    private static Map<Security, Integer> ids = new HashMap<>();
    ...
    SecurityFilterView(@NonNull SecurityFilter securityFilter, @NonNull Dialog dialog) {
        super(ids, securityFilter, dialog, R.id.filterSecurity);
    }
}
