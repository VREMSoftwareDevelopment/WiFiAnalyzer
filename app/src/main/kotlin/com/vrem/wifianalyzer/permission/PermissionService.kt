...
class PermissionService(
    ...
    private val locationPermission: LocationPermission = LocationPermission(mainActivity),
    private val applicationPermission: ApplicationPermission = ApplicationPermission(mainActivity),
) {
